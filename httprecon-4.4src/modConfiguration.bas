...
Public Const APP_NAME As String = "httprecon 4.4"
...
Public Sub LoadConfigFromFile(Optional ByRef sConfigurationFileName As String)
    ...
    If req_resource_notavailableV = False Then
        req_resource_notavailable = "/" & Chr$(Rand(97, 122)) & Chr$(Rand(65, 90)) & Rand(0, 9) & Chr$(Rand(97, 122)) & Chr$(Rand(65, 90)) & Rand(0, 9) & ".html"
    End If
    ...
    If req_longrequest_charV = False Then
        req_longrequest_char = Chr$(Rand(97, 122))
    End If
...
Public Sub WriteConfigurationToFile(ByRef sConfigurationFileName As String)
    ...
    cConfigContent.Concat "# Scan" & vbNewLine
    cConfigContent.Concat "scan_targethost=" & scan_targethost & vbNewLine
    cConfigContent.Concat "scan_targetport=" & scan_targetport & vbNewLine
    cConfigContent.Concat "scan_targetsecure=" & scan_targetsecure & vbNewLine
    cConfigContent.Concat vbNewLine
    cConfigContent.Concat "# Statistics" & vbNewLine
    cConfigContent.Concat "app_hitpoints_minimum=" & app_hitpoints_minimum & vbNewLine
    cConfigContent.Concat "app_hitpoints_maximum=" & app_hitpoints_maximum & vbNewLine
    cConfigContent.Concat vbNewLine
    cConfigContent.Concat "# Tests" & vbNewLine
    cConfigContent.Concat "scan_test_getexisting=" & scan_test_getexisting & vbNewLine
    cConfigContent.Concat "scan_test_getnonexisting=" & scan_test_getnonexisting & vbNewLine
    cConfigContent.Concat "scan_test_getlong=" & scan_test_getlong & vbNewLine
    cConfigContent.Concat "scan_test_head=" & scan_test_head & vbNewLine
    cConfigContent.Concat "scan_test_options=" & scan_test_options & vbNewLine
    cConfigContent.Concat "scan_test_wrongmethod=" & scan_test_wrongmethod & vbNewLine
    cConfigContent.Concat "scan_test_nonexistingmethod=" & scan_test_nonexistingmethod & vbNewLine
    cConfigContent.Concat "scan_test_wrongprotocol=" & scan_test_wrongprotocol & vbNewLine
    cConfigContent.Concat "scan_test_attack=" & scan_test_attack & vbNewLine
    cConfigContent.Concat vbNewLine
    cConfigContent.Concat "# Requests" & vbNewLine
    cConfigContent.Concat "req_timeout_connect=" & req_timeout_connect & vbNewLine
    cConfigContent.Concat "req_timeout_send=" & req_timeout_send & vbNewLine
    cConfigContent.Concat "req_timeout_receive=" & req_timeout_receive & vbNewLine
    cConfigContent.Concat "req_agent_name=" & req_agent_name & vbNewLine
    cConfigContent.Concat "req_protocol_legitimate=" & req_protocol_legitimate & vbNewLine
    cConfigContent.Concat "req_protocol_wrong=" & req_protocol_wrong & vbNewLine
    cConfigContent.Concat "req_resource_available=" & req_resource_available & vbNewLine
    cConfigContent.Concat "req_resource_notavailable=" & req_resource_notavailable & vbNewLine
    cConfigContent.Concat "req_resource_attack=" & req_resource_attack & vbNewLine
    cConfigContent.Concat "req_longrequest_length=" & req_longrequest_length & vbNewLine
    cConfigContent.Concat "req_longrequest_char=" & req_longrequest_char & vbNewLine
    cConfigContent.Concat "req_method_notallowed=" & req_method_notallowed & vbNewLine
    cConfigContent.Concat "req_method_notexisting=" & req_method_notexisting & vbNewLine
