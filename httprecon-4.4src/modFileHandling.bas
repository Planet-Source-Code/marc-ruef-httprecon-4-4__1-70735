...
Public Function GenerateFingerprintXML(ByRef bIncludeScanDetails As Boolean) As String
    ...
    If (bIncludeScanDetails = True) Then
        sFullFingerprint.Concat "<scan_targethost>" & vbCrLf & scan_targethost & vbCrLf & "</scan_targethost>" & vbCrLf
        sFullFingerprint.Concat "<scan_targetport>" & vbCrLf & scan_targetport & vbCrLf & "</scan_targetport>" & vbCrLf
        sFullFingerprint.Concat "<scan_targetsecure>" & vbCrLf & scan_targetsecure & vbCrLf & "</scan_targetsecure>" & vbCrLf
        sFullFingerprint.Concat "<scan_date>" & vbCrLf & scan_date & vbCrLf & "</scan_date>" & vbCrLf
        sFullFingerprint.Concat "<scan_time>" & vbCrLf & scan_time & vbCrLf & "</scan_time>" & vbCrLf & vbCrLf
    End If
